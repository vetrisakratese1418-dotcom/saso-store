...
export function CartDrawer({ open, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[80]">
      ...
      <aside className="absolute bottom-0 right-0 top-0 flex h-full w-full max-w-md flex-col bg-background shadow-2xl anim-slide-in-right lg:bottom-0 lg:left-auto lg:right-0">
        <div className="flex items-center justify-between border-b border-hairline px-4 py-3 sm:px-5 sm:py-4 safe-top">
          ...
          <button
            onClick={onClose}
            className="flex size-10 items-center justify-center rounded-full text-muted transition hover:bg-foreground/10 active:scale-90"
          ...
          <>
            <div className="flex-1 space-y-3 overflow-y-auto px-4 py-4 sm:px-5">
              {cart.map((item) => (
                <div
                  key={item.productId}
                  className="flex gap-3 rounded-2xl border border-hairline bg-card p-3 anim-fade-in"
                >
                  ...
                  <div className="flex flex-1 flex-col min-w-0">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <button
                        ...
                        className="shrink-0 text-muted transition hover:text-danger active:scale-90 min-h-[44px] min-w-[44px] flex items-center justify-center -mr-2"
                    ...
                    <div className="mt-auto flex items-center justify-between pt-2">
                      <div className="flex items-center rounded-full border border-hairline">
                        <button
                          ...
                          className="flex size-9 items-center justify-center text-muted hover:text-foreground active:scale-90"
            ...
            <div className="border-t border-hairline px-4 py-4 sm:px-5 safe-bottom">
